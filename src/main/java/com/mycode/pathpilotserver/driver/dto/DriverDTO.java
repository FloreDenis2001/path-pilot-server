...
public record DriverDTO(String username, String email, String firstName, String lastName, String phone, double salary, double rating, int experience, String licenseNumber, boolean isAvailable, Set<Route> routes) {
